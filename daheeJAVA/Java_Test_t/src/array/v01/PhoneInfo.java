...
public class PhoneInfo {
	 ...
	 * • 이름 name String • 전화번호 phoneNumber String • 생년월일 birthday String 저장된 데이터의
	 * 적절한 출력이 가능하도록 메소드 생성 생년월일 정보는 저장할 수도있고, 저장 않을 수도있게끔 생성자 생성
	 * 
	 */
	...
	void showInfo() {
		...
		// 생일에 아무런 정보가 없다면 "등록된 정보가 없습니다." 가 출력된다. (this(name, phoneNumber, "등록된 정보가
		// 없습니다.");에서 설정)
		System.out.println("생일 : " + birhday);

		/*
		 * if(birhday != null) { System.out.println("생일 : "+ birhday); } else {
