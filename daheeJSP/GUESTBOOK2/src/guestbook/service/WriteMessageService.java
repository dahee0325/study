...
public class WriteMessageService implements GuestBookService{
	...
	/*
	 * public int write(Message message) { int rCnt = 0;
	 * 
	 * //1. Connection 생성 //2. dao 생성 //3. insert 메서드 시랭
	 * 
	 ...
	 * 
	 * } catch(SQLException e) { e.printStackTrace(); } return rCnt; }
	 */
	...
	public String getViewName(HttpServletRequest request, HttpServletResponse response) {
		...
		//2. Message 객체 생성
		Message ms = new Message(0, guestName, password, message);
